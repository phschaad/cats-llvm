...
int main() {
  ...
  cats_trace_instrument_scope_entry(1, 0, CATS_SCOPE_TYPE_FUNCTION, __func__, __FILE__, __LINE__, 0);
  ...
  cats_trace_instrument_scope_entry(1, 1, CATS_SCOPE_TYPE_LOOP, __func__, __FILE__, __LINE__, 0);
  ...
  cats_trace_instrument_scope_exit(5, 1, __func__, __FILE__, __LINE__, 0);
  ...
  cats_trace_instrument_scope_exit(6, 0, __func__, __FILE__, __LINE__, 0);
